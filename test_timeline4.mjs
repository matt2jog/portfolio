...
async function testGitHubEvents() {
  console.log(`Testing private events for user: ${username}`);
  let totalEvents = 0;
  let page = 1;
  while(page <= 5) {
